...
1. **[WKOpenVR](https://github.com/RealWhyKnot/WKOpenVR)** -- the OpenVR-Pair umbrella. Its `modules/facetracking/` directory contains the face-tracking host sidecar (C# / .NET 10), the reflecting adapter that loads upstream `ExtTrackingModule` implementations at runtime, the SteamVR driver-side calibration / vergence-lock / eyelid-sync math, and the overlay UI.
...
Issues and contributions: [WKOpenVR/issues](https://github.com/RealWhyKnot/WKOpenVR/issues).
